    ...
    def create_snapshot(self):
        ...
        try:
            if os.path.exists(self.classisland_path):
                ...
                if(not self._zip_dir(self.classisland_path, os.path.join(self.snapshot_path, zip_name))):
                    return False
                os.makedirs(self.recovery_snapshot_path, exist_ok=True)
                if(not self._zip_dir(self.classisland_path, os.path.join(self.recovery_snapshot_path, zip_name))):
                    return False
                return zip_name
            else:
                return False
